...
vars = {
  ...
  'dawn_gn_version': 'git_revision:f9116e30e34ac9d33f420ca9917ec362221caded',
  ...
  # were last synced to.
  'chromium_revision': '937fe78594736c74fb5228902d73a488ac118952',
...
deps = {
  ...
  'third_party/clang-format/script': {
    'url': '{chromium_git}/external/github.com/llvm/llvm-project/clang/tools/clang-format.git@08cce2b81a4d9801ebeaa8cdb43b241475a4d521',
    'condition': 'dawn_standalone',
  },
  'buildtools/linux64': {
    'packages': [{
  ...
  'third_party/depot_tools': {
    'url': '{chromium_git}/chromium/tools/depot_tools.git@de15c6313c9dd9caef5737f292ebc95716044747',
    'condition': 'dawn_standalone',
  },
  ...
  'third_party/llvm-libc/src': {
    'url': '{chromium_git}/external/github.com/llvm/llvm-project/libc.git@eeef9c842b25c6f32d8fc773b8c1d4eaf23be826',
    'condition': 'dawn_standalone',
  },
  ...
  'build': {
  'url': '{chromium_git}/chromium/src/build@08cae1166f77101a3ef811fc98942943dd68388a',
    'condition': 'dawn_standalone',
  },
  'tools/clang': {
  'url': '{chromium_git}/chromium/src/tools/clang@772ec0f7db794d7c9bc4df748935ff13aaed36d7',
    'condition': 'dawn_standalone',
  },
  'tools/memory': {
    'url': '{chromium_git}/chromium/src/tools/memory@b635f27e932356a2e29450e5cfa544cdcc9ea6bb',
    'condition': 'dawn_standalone',
  },
  'tools/valgrind': {
  ...
  'tools/mb': {
    'url': '{chromium_git}/chromium/src/tools/mb@dfa6825f1ac6f78747be94bc3aa4193bf0b7faa6',
    'condition': 'dawn_standalone',
  },

  # Testing, GTest and GMock
  'testing': {
    'url': '{chromium_git}/chromium/src/testing@3e9181913b55d55cc291f737194d9d70741d85a5',
    'condition': 'dawn_standalone',
  },
  ...
  'third_party/angle': {
    'url': '{chromium_git}/angle/angle@fd958ac6533eb789e56801b558c9de15af17792c',
    'condition': 'dawn_standalone',
  },

  'third_party/swiftshader': {
    'url': '{swiftshader_git}/SwiftShader@89556131bf9d48af3c5c9fbb9a3322e706da89a3',
    'condition': 'dawn_standalone',
  },

  'third_party/vulkan-deps': {
    'url': '{chromium_git}/vulkan-deps@3250831400662e4d9f3d7d5af5ca771546718c9e',
    'condition': 'dawn_standalone',
  },
  ...
  'third_party/spirv-headers/src': {
    'url': '{chromium_git}/external/github.com/KhronosGroup/SPIRV-Headers@ce9dfb01496073a02d74581ae909384763b41ff8',
    'condition': 'dawn_standalone',
  },

  'third_party/spirv-tools/src': {
    'url': '{chromium_git}/external/github.com/KhronosGroup/SPIRV-Tools@34bc8ea6f3f84d5ed7739daa66b01e7273aed458',
    'condition': 'dawn_standalone',
  },
  ...
  'third_party/vulkan-validation-layers/src': {
    'url': '{chromium_git}/external/github.com/KhronosGroup/Vulkan-ValidationLayers@cb2acdf7f49053406770ae73cbb315229a9131eb',
    'condition': 'dawn_standalone',
  },

  'third_party/zlib': {
    'url': '{chromium_git}/chromium/src/third_party/zlib@b80f1d1e5256ac25f6aea3f31f13d458981cb1f9',
    'condition': 'dawn_standalone',
  },

  'third_party/abseil-cpp': {
    'url': '{chromium_git}/chromium/src/third_party/abseil-cpp@dd4432fb02583b7a5b2b4fbf2012f7053e286ce0',
    'condition': 'dawn_standalone',
  },

  'third_party/dxc': {
    'url': '{chromium_git}/external/github.com/microsoft/DirectXShaderCompiler@ec968abfaa505c7ac863827e302389e623036a09',
  },
  ...
  'third_party/OpenGL-Registry/src': {
    'url': '{chromium_git}/external/github.com/KhronosGroup/OpenGL-Registry@9cb90ca4902d588bef3c830fbb1da484893bd5fb',
  },
  ...
  'third_party/webgpu-cts': {
    'url': '{chromium_git}/external/github.com/gpuweb/cts@09fdb847d90d0b5bfe57068ce2eb9283cb77fc7f',
  ...
  'third_party/emsdk': {
    ...
    'url': '{chromium_git}/external/github.com/emscripten-core/emsdk.git@b4258c35121c8d0e12f53568ffb22236d7816723',
    'condition': 'dawn_wasm',
  },
  ...
  'third_party/protobuf': {
    'url': '{chromium_git}/chromium/src/third_party/protobuf@04bb12d7ca5e16c58b55012acb32f07c89dd4e2b',
    'condition': 'dawn_standalone',
  },
  ...
  'third_party/partition_alloc': {
    'url': '{chromium_git}/chromium/src/base/allocator/partition_allocator.git@c6953320d41d503d7957b9fc3b9c26bee408165c',
    'condition': 'dawn_standalone',
  },
