...
void main() {
  ...
  vec4 red = tint_TextureLoadMultiplanarExternal(v_51, min(uvec2(ivec2(10)), ((v_51.apparentSize + uvec2(1u)) - uvec2(1u))));
  imageStore(outImage, ivec2(0), red);
  tint_ExternalTextureParams v_52 = v_31(0u);
  vec4 green = tint_TextureLoadMultiplanarExternal(v_52, min(uvec2(ivec2(70, 118)), ((v_52.apparentSize + uvec2(1u)) - uvec2(1u))));
