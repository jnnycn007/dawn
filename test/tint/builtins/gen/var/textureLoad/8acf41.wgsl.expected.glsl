...
vec4 textureLoad_8acf41() {
  ...
  vec4 res = tint_TextureLoadMultiplanarExternal(v_52, min(uvec2(arg_1), ((v_52.apparentSize + uvec2(1u)) - uvec2(1u))));
  return res;
}
void main() {
...
vec4 textureLoad_8acf41() {
  ...
  vec4 res = tint_TextureLoadMultiplanarExternal(v_51, min(uvec2(arg_1), ((v_51.apparentSize + uvec2(1u)) - uvec2(1u))));
  return res;
}
