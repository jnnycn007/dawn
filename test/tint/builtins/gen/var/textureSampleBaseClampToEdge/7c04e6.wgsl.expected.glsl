...
vec3 tint_ApplyTransferFunction(vec3 v, tint_TransferFunctionParams params) {
...
vec4 tint_TextureSampleClampToEdgeMultiplanarExternal(tint_ExternalTextureParams params, vec2 coords) {
  ...
  if ((params.doYuvToRgbConversionOnly == 0u)) {
    v_9 = tint_ApplyTransferFunction((params.gamutConversionMatrix * tint_ApplyTransferFunction(v_8, params.srcTransferFunction)), params.dstTransferFunction);
  } else {
    v_9 = v_8;
  }
  return vec4(v_9, v_6);
...
mat3x2 v_10(uint start_byte_offset) {
  ...
  vec2 v_12 = uintBitsToFloat(mix(v_11.xy, v_11.zw, bvec2((((start_byte_offset & 15u) >> 2u) == 2u))));
  uvec4 v_13 = v_2.inner[((8u + start_byte_offset) / 16u)];
  vec2 v_14 = uintBitsToFloat(mix(v_13.xy, v_13.zw, bvec2(((((8u + start_byte_offset) & 15u) >> 2u) == 2u))));
  uvec4 v_15 = v_2.inner[((16u + start_byte_offset) / 16u)];
  return mat3x2(v_12, v_14, uintBitsToFloat(mix(v_15.xy, v_15.zw, bvec2(((((16u + start_byte_offset) & 15u) >> 2u) == 2u)))));
}
...
tint_TransferFunctionParams v_17(uint start_byte_offset) {
  ...
  return tint_TransferFunctionParams(v_18[((start_byte_offset & 15u) >> 2u)], uintBitsToFloat(v_19[(((4u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_20[(((8u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_21[(((12u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_22[(((16u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_23[(((20u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_24[(((24u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_25[(((28u + start_byte_offset) & 15u) >> 2u)]));
}
...
tint_ExternalTextureParams v_27(uint start_byte_offset) {
  ...
  tint_TransferFunctionParams v_31 = v_17((64u + start_byte_offset));
  tint_TransferFunctionParams v_32 = v_17((96u + start_byte_offset));
  ...
  vec2 v_37 = uintBitsToFloat(mix(v_36.xy, v_36.zw, bvec2(((((224u + start_byte_offset) & 15u) >> 2u) == 2u))));
  uvec4 v_38 = v_2.inner[((232u + start_byte_offset) / 16u)];
  vec2 v_39 = uintBitsToFloat(mix(v_38.xy, v_38.zw, bvec2(((((232u + start_byte_offset) & 15u) >> 2u) == 2u))));
  uvec4 v_40 = v_2.inner[((240u + start_byte_offset) / 16u)];
  vec2 v_41 = uintBitsToFloat(mix(v_40.xy, v_40.zw, bvec2(((((240u + start_byte_offset) & 15u) >> 2u) == 2u))));
  uvec4 v_42 = v_2.inner[((248u + start_byte_offset) / 16u)];
  vec2 v_43 = uintBitsToFloat(mix(v_42.xy, v_42.zw, bvec2(((((248u + start_byte_offset) & 15u) >> 2u) == 2u))));
  uvec4 v_44 = v_2.inner[((256u + start_byte_offset) / 16u)];
  uvec2 v_45 = mix(v_44.xy, v_44.zw, bvec2(((((256u + start_byte_offset) & 15u) >> 2u) == 2u)));
...
vec4 textureSampleBaseClampToEdge_7c04e6() {
  ...
  tint_ExternalTextureParams v_47 = v_27(0u);
  vec4 res = tint_TextureSampleClampToEdgeMultiplanarExternal(v_47, arg_2);
  return res;
}
void main() {
...
vec4 tint_TextureSampleClampToEdgeMultiplanarExternal(tint_ExternalTextureParams params, vec2 coords) {
  ...
  vec3 v_8 = vec3(0.0f);
  if ((params.doYuvToRgbConversionOnly == 0u)) {
    v_8 = tint_ApplyTransferFunction((params.gamutConversionMatrix * tint_ApplyTransferFunction(v_7, params.srcTransferFunction)), params.dstTransferFunction);
  } else {
    v_8 = v_7;
  }
  return vec4(v_8, v_5);
...
mat3x2 v_9(uint start_byte_offset) {
  ...
  vec2 v_11 = uintBitsToFloat(mix(v_10.xy, v_10.zw, bvec2((((start_byte_offset & 15u) >> 2u) == 2u))));
  uvec4 v_12 = v_1.inner[((8u + start_byte_offset) / 16u)];
  vec2 v_13 = uintBitsToFloat(mix(v_12.xy, v_12.zw, bvec2(((((8u + start_byte_offset) & 15u) >> 2u) == 2u))));
  uvec4 v_14 = v_1.inner[((16u + start_byte_offset) / 16u)];
  return mat3x2(v_11, v_13, uintBitsToFloat(mix(v_14.xy, v_14.zw, bvec2(((((16u + start_byte_offset) & 15u) >> 2u) == 2u)))));
}
...
tint_TransferFunctionParams v_16(uint start_byte_offset) {
  ...
  return tint_TransferFunctionParams(v_17[((start_byte_offset & 15u) >> 2u)], uintBitsToFloat(v_18[(((4u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_19[(((8u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_20[(((12u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_21[(((16u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_22[(((20u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_23[(((24u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_24[(((28u + start_byte_offset) & 15u) >> 2u)]));
}
...
tint_ExternalTextureParams v_26(uint start_byte_offset) {
  ...
  tint_TransferFunctionParams v_30 = v_16((64u + start_byte_offset));
  tint_TransferFunctionParams v_31 = v_16((96u + start_byte_offset));
  ...
  vec2 v_36 = uintBitsToFloat(mix(v_35.xy, v_35.zw, bvec2(((((224u + start_byte_offset) & 15u) >> 2u) == 2u))));
  uvec4 v_37 = v_1.inner[((232u + start_byte_offset) / 16u)];
  vec2 v_38 = uintBitsToFloat(mix(v_37.xy, v_37.zw, bvec2(((((232u + start_byte_offset) & 15u) >> 2u) == 2u))));
  uvec4 v_39 = v_1.inner[((240u + start_byte_offset) / 16u)];
  vec2 v_40 = uintBitsToFloat(mix(v_39.xy, v_39.zw, bvec2(((((240u + start_byte_offset) & 15u) >> 2u) == 2u))));
  uvec4 v_41 = v_1.inner[((248u + start_byte_offset) / 16u)];
  vec2 v_42 = uintBitsToFloat(mix(v_41.xy, v_41.zw, bvec2(((((248u + start_byte_offset) & 15u) >> 2u) == 2u))));
  uvec4 v_43 = v_1.inner[((256u + start_byte_offset) / 16u)];
  uvec2 v_44 = mix(v_43.xy, v_43.zw, bvec2(((((256u + start_byte_offset) & 15u) >> 2u) == 2u)));
...
vec4 textureSampleBaseClampToEdge_7c04e6() {
  vec2 arg_2 = vec2(1.0f);
  tint_ExternalTextureParams v_46 = v_26(0u);
  vec4 res = tint_TextureSampleClampToEdgeMultiplanarExternal(v_46, arg_2);
  return res;
}
VertexOutput vertex_main_inner() {
  VertexOutput v_47 = VertexOutput(vec4(0.0f), vec4(0.0f));
  v_47.pos = vec4(0.0f);
  v_47.prevent_dce = textureSampleBaseClampToEdge_7c04e6();
  return v_47;
}
void main() {
  VertexOutput v_48 = vertex_main_inner();
  gl_Position = vec4(v_48.pos.x, -(v_48.pos.y), ((2.0f * v_48.pos.z) - v_48.pos.w), v_48.pos.w);
  tint_interstage_location0 = v_48.prevent_dce;
  gl_PointSize = 1.0f;
}
