...
tint_ExternalTextureParams v_19(uint start_byte_offset) {
  ...
  vec2 v_29 = uintBitsToFloat(mix(v_28.xy, v_28.zw, bvec2(((((224u + start_byte_offset) & 15u) >> 2u) == 2u))));
  uvec4 v_30 = v_1.inner[((232u + start_byte_offset) / 16u)];
  vec2 v_31 = uintBitsToFloat(mix(v_30.xy, v_30.zw, bvec2(((((232u + start_byte_offset) & 15u) >> 2u) == 2u))));
  uvec4 v_32 = v_1.inner[((240u + start_byte_offset) / 16u)];
  vec2 v_33 = uintBitsToFloat(mix(v_32.xy, v_32.zw, bvec2(((((240u + start_byte_offset) & 15u) >> 2u) == 2u))));
  uvec4 v_34 = v_1.inner[((248u + start_byte_offset) / 16u)];
  vec2 v_35 = uintBitsToFloat(mix(v_34.xy, v_34.zw, bvec2(((((248u + start_byte_offset) & 15u) >> 2u) == 2u))));
  uvec4 v_36 = v_1.inner[((256u + start_byte_offset) / 16u)];
  uvec2 v_37 = mix(v_36.xy, v_36.zw, bvec2(((((256u + start_byte_offset) & 15u) >> 2u) == 2u)));
  uvec4 v_38 = v_1.inner[((264u + start_byte_offset) / 16u)];
  return tint_ExternalTextureParams(v_20[((start_byte_offset & 15u) >> 2u)], v_21[(((4u + start_byte_offset) & 15u) >> 2u)], v_22, v_23, v_24, v_25, v_26, v_27, v_29, v_31, v_33, v_35, v_37, uintBitsToFloat(mix(v_38.xy, v_38.zw, bvec2(((((264u + start_byte_offset) & 15u) >> 2u) == 2u)))));
}
