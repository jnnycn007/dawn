...
Matrix_result_f16_8x8 subgroupMatrixMultiplyAccumulate_8b907c() {
  Matrix_result_f16_8x8 res = tint_MatrixMultiplyAccumulate(Matrix_left_f16_8x8::Splat(float16_t(0.0h)), Matrix_right_f16_8x8::Splat(float16_t(0.0h)), Matrix_result_f16_8x8::Splat(float16_t(0.0h)));
  return res;
}
