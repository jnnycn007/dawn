...
vec4 tint_TextureLoadMultiplanarExternal(tint_ExternalTextureParams params, uvec2 coords) {
  ...
  if ((params.doYuvToRgbConversionOnly == 0u)) {
    v_14 = tint_ApplyTransferFunction((params.gamutConversionMatrix * tint_ApplyTransferFunction(v_13, params.srcTransferFunction)), params.dstTransferFunction);
  } else {
    v_14 = v_13;
  }
...
tint_TransferFunctionParams v_22(uint start_byte_offset) {
  ...
  return tint_TransferFunctionParams(v_23[((start_byte_offset & 15u) >> 2u)], uintBitsToFloat(v_24[(((4u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_25[(((8u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_26[(((12u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_27[(((16u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_28[(((20u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_29[(((24u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_30[(((28u + start_byte_offset) & 15u) >> 2u)]));
}
...
tint_ExternalTextureParams v_32(uint start_byte_offset) {
  ...
  tint_TransferFunctionParams v_36 = v_22((64u + start_byte_offset));
  tint_TransferFunctionParams v_37 = v_22((96u + start_byte_offset));
...
vec4 textureLoad_8acf41() {
  ...
  vec4 res = tint_TextureLoadMultiplanarExternal(v_52, min(uvec2(ivec2(1)), ((v_52.apparentSize + uvec2(1u)) - uvec2(1u))));
  return res;
}
void main() {
...
vec4 tint_TextureLoadMultiplanarExternal(tint_ExternalTextureParams params, uvec2 coords) {
  ...
  vec3 v_13 = vec3(0.0f);
  if ((params.doYuvToRgbConversionOnly == 0u)) {
    v_13 = tint_ApplyTransferFunction((params.gamutConversionMatrix * tint_ApplyTransferFunction(v_12, params.srcTransferFunction)), params.dstTransferFunction);
  } else {
    v_13 = v_12;
  }
...
tint_TransferFunctionParams v_21(uint start_byte_offset) {
  ...
  return tint_TransferFunctionParams(v_22[((start_byte_offset & 15u) >> 2u)], uintBitsToFloat(v_23[(((4u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_24[(((8u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_25[(((12u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_26[(((16u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_27[(((20u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_28[(((24u + start_byte_offset) & 15u) >> 2u)]), uintBitsToFloat(v_29[(((28u + start_byte_offset) & 15u) >> 2u)]));
}
...
tint_ExternalTextureParams v_31(uint start_byte_offset) {
  ...
  tint_TransferFunctionParams v_35 = v_21((64u + start_byte_offset));
  tint_TransferFunctionParams v_36 = v_21((96u + start_byte_offset));
...
vec4 textureLoad_8acf41() {
  ...
  vec4 res = tint_TextureLoadMultiplanarExternal(v_51, min(uvec2(ivec2(1)), ((v_51.apparentSize + uvec2(1u)) - uvec2(1u))));
  return res;
}
VertexOutput vertex_main_inner() {
  VertexOutput v_52 = VertexOutput(vec4(0.0f), vec4(0.0f));
  v_52.pos = vec4(0.0f);
  v_52.prevent_dce = textureLoad_8acf41();
  return v_52;
}
void main() {
