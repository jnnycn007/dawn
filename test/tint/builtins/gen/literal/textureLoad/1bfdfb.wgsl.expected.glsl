...
vec4 textureLoad_1bfdfb() {
  ...
  vec4 res = tint_TextureLoadMultiplanarExternal(v_52, min(uvec2(1u), ((v_52.apparentSize + uvec2(1u)) - uvec2(1u))));
  return res;
}
void main() {
...
vec4 textureLoad_1bfdfb() {
  ...
  vec4 res = tint_TextureLoadMultiplanarExternal(v_51, min(uvec2(1u), ((v_51.apparentSize + uvec2(1u)) - uvec2(1u))));
  return res;
}
