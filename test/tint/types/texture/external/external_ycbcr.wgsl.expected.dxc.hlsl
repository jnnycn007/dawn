...
float3x2 v_24(uint start_byte_offset) {
  uint4 v_25 = t_f_params[(start_byte_offset / 16u)];
  uint4 v_26 = t_f_params[((8u + start_byte_offset) / 16u)];
  uint4 v_27 = t_f_params[((16u + start_byte_offset) / 16u)];
...
tint_TransferFunctionParams v_29(uint start_byte_offset) {
  tint_TransferFunctionParams v_30 = {t_f_params[(start_byte_offset / 16u)][((start_byte_offset & 15u) >> 2u)], asfloat(t_f_params[((4u + start_byte_offset) / 16u)][(((4u + start_byte_offset) & 15u) >> 2u)]), asfloat(t_f_params[((8u + start_byte_offset) / 16u)][(((8u + start_byte_offset) & 15u) >> 2u)]), asfloat(t_f_params[((12u + start_byte_offset) / 16u)][(((12u + start_byte_offset) & 15u) >> 2u)]), asfloat(t_f_params[((16u + start_byte_offset) / 16u)][(((16u + start_byte_offset) & 15u) >> 2u)]), asfloat(t_f_params[((20u + start_byte_offset) / 16u)][(((20u + start_byte_offset) & 15u) >> 2u)]), asfloat(t_f_params[((24u + start_byte_offset) / 16u)][(((24u + start_byte_offset) & 15u) >> 2u)]), asfloat(t_f_params[((28u + start_byte_offset) / 16u)][(((28u + start_byte_offset) & 15u) >> 2u)])};
  return v_30;
}
...
tint_ExternalTextureParams v_32(uint start_byte_offset) {
  uint v_33 = t_f_params[(start_byte_offset / 16u)][((start_byte_offset & 15u) >> 2u)];
  uint v_34 = t_f_params[((4u + start_byte_offset) / 16u)][(((4u + start_byte_offset) & 15u) >> 2u)];
  ...
  uint4 v_41 = t_f_params[((224u + start_byte_offset) / 16u)];
  uint4 v_42 = t_f_params[((232u + start_byte_offset) / 16u)];
  uint4 v_43 = t_f_params[((240u + start_byte_offset) / 16u)];
  uint4 v_44 = t_f_params[((248u + start_byte_offset) / 16u)];
