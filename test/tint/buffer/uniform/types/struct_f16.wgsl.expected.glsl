...
f16mat2x4 v_2(uint start_byte_offset) {
  ...
  return f16mat2x4(v_4, tint_bitcast_to_16bit_1(mix(v_5.xy, v_5.zw, bvec2(((((8u + start_byte_offset) & 15u) >> 2u) == 2u)))));
}
...
Inner v_6(uint start_byte_offset) {
  ...
  float16_t v_8 = tint_bitcast_to_16bit(v_7[((start_byte_offset & 15u) >> 2u)])[mix(1u, 0u, ((start_byte_offset % 4u) == 0u))];
  uvec4 v_9 = v.inner[((8u + start_byte_offset) / 16u)];
  f16vec3 v_10 = tint_bitcast_to_16bit_1(mix(v_9.xy, v_9.zw, bvec2(((((8u + start_byte_offset) & 15u) >> 2u) == 2u)))).xyz;
