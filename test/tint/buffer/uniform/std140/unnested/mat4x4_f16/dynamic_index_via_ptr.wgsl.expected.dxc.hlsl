...
matrix<float16_t, 4, 4> v_1(uint start_byte_offset) {
  ...
  vector<float16_t, 4> v_5 = tint_bitcast_to_f16(((((((8u + start_byte_offset) & 15u) >> 2u) == 2u)) ? (v_4.zw) : (v_4.xy)));
  uint4 v_6 = m[((16u + start_byte_offset) / 16u)];
  vector<float16_t, 4> v_7 = tint_bitcast_to_f16(((((((16u + start_byte_offset) & 15u) >> 2u) == 2u)) ? (v_6.zw) : (v_6.xy)));
  uint4 v_8 = m[((24u + start_byte_offset) / 16u)];
  return matrix<float16_t, 4, 4>(v_3, v_5, v_7, tint_bitcast_to_f16(((((((24u + start_byte_offset) & 15u) >> 2u) == 2u)) ? (v_8.zw) : (v_8.xy))));
}
...
void f() {
  ...
  vector<float16_t, 4> l_m_i = tint_bitcast_to_f16((((((v_9 & 15u) >> 2u) == 2u)) ? (v_10.zw) : (v_10.xy)));
}
