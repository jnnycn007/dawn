...
f16mat3 v_2(uint start_byte_offset) {
  ...
  return f16mat3(v_4, v_6, tint_bitcast_to_16bit_1(mix(v_7.xy, v_7.zw, bvec2(((((16u + start_byte_offset) & 15u) >> 2u) == 2u)))).xyz);
}
...
void main() {
  ...
  v_1.inner[0u].y = tint_bitcast_to_16bit(v_8.z).x;
}
