...
matrix<float16_t, 3, 4> v_3(uint start_byte_offset) {
  ...
  return matrix<float16_t, 3, 4>(v_5, v_7, tint_bitcast_to_f16_1(((((((16u + start_byte_offset) & 15u) >> 2u) == 2u)) ? (v_8.zw) : (v_8.xy))));
}
