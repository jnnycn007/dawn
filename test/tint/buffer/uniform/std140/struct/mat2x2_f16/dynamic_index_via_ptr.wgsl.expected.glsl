...
f16mat2 v_2(uint start_byte_offset) {
  ...
  return f16mat2(v_3, tint_bitcast_to_16bit(v.inner[((4u + start_byte_offset) / 16u)][(((4u + start_byte_offset) & 15u) >> 2u)]));
}
...
void main() {
  ...
  f16vec2 l_a_i_a_i_m_i = tint_bitcast_to_16bit(v.inner[(((v_12 + v_13) + v_14) / 16u)][((((v_12 + v_13) + v_14) & 15u) >> 2u)]);
  uint v_15 = (((v_12 + v_13) + v_14) + (min(uint(i()), 1u) * 2u));
  uvec4 v_16 = v.inner[(v_15 / 16u)];
  float16_t l_a_i_a_i_m_i_i = tint_bitcast_to_16bit(v_16[((v_15 & 15u) >> 2u)])[mix(1u, 0u, ((v_15 % 4u) == 0u))];
}
