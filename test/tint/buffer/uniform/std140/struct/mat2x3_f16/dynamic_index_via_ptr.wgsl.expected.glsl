...
f16mat2x3 v_2(uint start_byte_offset) {
  ...
  return f16mat2x3(v_4, tint_bitcast_to_16bit(mix(v_5.xy, v_5.zw, bvec2(((((8u + start_byte_offset) & 15u) >> 2u) == 2u)))).xyz);
}
...
void main() {
  ...
  f16vec3 l_a_i_a_i_m_i = tint_bitcast_to_16bit(mix(v_17.xy, v_17.zw, bvec2((((((v_14 + v_15) + v_16) & 15u) >> 2u) == 2u)))).xyz;
  uint v_18 = (((v_14 + v_15) + v_16) + (min(uint(i()), 2u) * 2u));
  uvec4 v_19 = v.inner[(v_18 / 16u)];
  float16_t l_a_i_a_i_m_i_i = tint_bitcast_to_16bit_1(v_19[((v_18 & 15u) >> 2u)])[mix(1u, 0u, ((v_18 % 4u) == 0u))];
}
