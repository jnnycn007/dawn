...
f16mat2x3 v_1(uint start_byte_offset) {
  ...
  return f16mat2x3(v_3, tint_bitcast_to_16bit(mix(v_4.xy, v_4.zw, bvec2(((((8u + start_byte_offset) & 15u) >> 2u) == 2u)))).xyz);
}
...
void main() {
  ...
  float16_t l_a_3_a_2_m_1_0 = tint_bitcast_to_16bit_1(v_13.z).x;
}
