...
void f() {
  ...
  matrix<float16_t, 2, 3> l_a_i_a_i_m = v_2((v_21 + v_22));
  uint4 v_24 = a[(((v_21 + v_22) + v_23) / 16u)];
  vector<float16_t, 3> l_a_i_a_i_m_i = tint_bitcast_to_f16(select((((((v_21 + v_22) + v_23) & 15u) >> 2u) == 2u), v_24.zw, v_24.xy)).xyz;
  uint v_25 = (((v_21 + v_22) + v_23) + (min(uint(i()), 2u) * 2u));
