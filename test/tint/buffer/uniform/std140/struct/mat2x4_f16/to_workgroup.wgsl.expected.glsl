...
f16mat2x4 v_1(uint start_byte_offset) {
  ...
  return f16mat2x4(v_3, tint_bitcast_to_16bit(mix(v_4.xy, v_4.zw, bvec2(((((8u + start_byte_offset) & 15u) >> 2u) == 2u)))));
}
S v_5(uint start_byte_offset) {
  uvec4 v_6 = v.inner[(start_byte_offset / 16u)];
  int v_7 = int(v_6[((start_byte_offset & 15u) >> 2u)]);
  f16mat2x4 v_8 = v_1((8u + start_byte_offset));
...
S[4] v_10(uint start_byte_offset) {
  S a[4] = S[4](S(0, f16mat2x4(f16vec4(0.0hf), f16vec4(0.0hf)), 0), S(0, f16mat2x4(f16vec4(0.0hf), f16vec4(0.0hf)), 0), S(0, f16mat2x4(f16vec4(0.0hf), f16vec4(0.0hf)), 0), S(0, f16mat2x4(f16vec4(0.0hf), f16vec4(0.0hf)), 0));
  {
    uint v_11 = 0u;
    v_11 = 0u;
    while(true) {
...
void f_inner(uint tint_local_index) {
  {
    ...
    while(true) {
      ...
      w[v_14] = S(0, f16mat2x4(f16vec4(0.0hf), f16vec4(0.0hf)), 0);
      {
        v_13 = (v_14 + 1u);
      }
    }
