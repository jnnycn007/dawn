...
matrix<float16_t, 4, 3> v_2(uint start_byte_offset) {
  ...
  vector<float16_t, 3> v_8 = tint_bitcast_to_f16_1(((((((16u + start_byte_offset) & 15u) >> 2u) == 2u)) ? (v_7.zw) : (v_7.xy))).xyz;
  uint4 v_9 = u[((24u + start_byte_offset) / 16u)];
  return matrix<float16_t, 4, 3>(v_4, v_6, v_8, tint_bitcast_to_f16_1(((((((24u + start_byte_offset) & 15u) >> 2u) == 2u)) ? (v_9.zw) : (v_9.xy))).xyz);
}
