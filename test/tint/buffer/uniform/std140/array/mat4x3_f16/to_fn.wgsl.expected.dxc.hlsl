...
ary_ret v_9(uint start_byte_offset) {
  ...
  matrix<float16_t, 4, 3> v_12[4] = a_2;
  return v_12;
}

[numthreads(1, 1, 1)]
void f() {
  matrix<float16_t, 4, 3> v_13[4] = v_9(0u);
  float16_t v_14 = a(v_13);
  float16_t v_15 = (v_14 + b(v_1(32u)));
  float16_t v_16 = (v_15 + c(tint_bitcast_to_f16(u[2u].xy).xyz.zxy));
  s.Store<float16_t>(0u, (v_16 + d(tint_bitcast_to_f16(u[2u].xy).xyz.zxy.x)));
}
