...
matrix<float16_t, 4, 3> v_3(uint start_byte_offset) {
  ...
  vector<float16_t, 3> v_9 = tint_bitcast_to_f16_1(((((((16u + start_byte_offset) & 15u) >> 2u) == 2u)) ? (v_8.zw) : (v_8.xy))).xyz;
  uint4 v_10 = u[((24u + start_byte_offset) / 16u)];
  return matrix<float16_t, 4, 3>(v_5, v_7, v_9, tint_bitcast_to_f16_1(((((((24u + start_byte_offset) & 15u) >> 2u) == 2u)) ? (v_10.zw) : (v_10.xy))).xyz);
}
