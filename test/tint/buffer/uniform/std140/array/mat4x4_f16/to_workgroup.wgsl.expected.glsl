...
f16mat4 v_1(uint start_byte_offset) {
  ...
  f16vec4 v_5 = tint_bitcast_to_16bit_1(mix(v_4.xy, v_4.zw, bvec2(((((8u + start_byte_offset) & 15u) >> 2u) == 2u))));
  uvec4 v_6 = v.inner[((16u + start_byte_offset) / 16u)];
  f16vec4 v_7 = tint_bitcast_to_16bit_1(mix(v_6.xy, v_6.zw, bvec2(((((16u + start_byte_offset) & 15u) >> 2u) == 2u))));
  uvec4 v_8 = v.inner[((24u + start_byte_offset) / 16u)];
  return f16mat4(v_3, v_5, v_7, tint_bitcast_to_16bit_1(mix(v_8.xy, v_8.zw, bvec2(((((24u + start_byte_offset) & 15u) >> 2u) == 2u)))));
}
f16mat4[4] v_9(uint start_byte_offset) {
...
void f_inner(uint tint_local_index) {
  {
    ...
    while(true) {
      ...
      w[v_13] = f16mat4(f16vec4(0.0hf), f16vec4(0.0hf), f16vec4(0.0hf), f16vec4(0.0hf));
      {
        v_12 = (v_13 + 1u);
      }
    }
  ...
  w[1u][0u].x = tint_bitcast_to_16bit(v_14.z).x;
}
