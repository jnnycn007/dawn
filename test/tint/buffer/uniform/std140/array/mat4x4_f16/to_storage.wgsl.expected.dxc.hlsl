...
matrix<float16_t, 4, 4> v_3(uint start_byte_offset) {
  ...
  vector<float16_t, 4> v_5 = tint_bitcast_to_f16_1((((((start_byte_offset & 15u) >> 2u) == 2u)) ? (v_4.zw) : (v_4.xy)));
  uint4 v_6 = u[((8u + start_byte_offset) / 16u)];
  vector<float16_t, 4> v_7 = tint_bitcast_to_f16_1(((((((8u + start_byte_offset) & 15u) >> 2u) == 2u)) ? (v_6.zw) : (v_6.xy)));
  uint4 v_8 = u[((16u + start_byte_offset) / 16u)];
  vector<float16_t, 4> v_9 = tint_bitcast_to_f16_1(((((((16u + start_byte_offset) & 15u) >> 2u) == 2u)) ? (v_8.zw) : (v_8.xy)));
  uint4 v_10 = u[((24u + start_byte_offset) / 16u)];
  return matrix<float16_t, 4, 4>(v_5, v_7, v_9, tint_bitcast_to_f16_1(((((((24u + start_byte_offset) & 15u) >> 2u) == 2u)) ? (v_10.zw) : (v_10.xy))));
}

void v_11(uint offset, matrix<float16_t, 4, 4> obj[4]) {
  {
    uint v_12 = 0u;
    v_12 = 0u;
    while(true) {
...
ary_ret v_14(uint start_byte_offset) {
  ...
  matrix<float16_t, 4, 4> v_17[4] = a;
  return v_17;
}

[numthreads(1, 1, 1)]
void f() {
  matrix<float16_t, 4, 4> v_18[4] = v_14(0u);
  v_11(0u, v_18);
  v_2(32u, v_3(64u));
