...
f16mat2x3 v_3(uint start_byte_offset) {
  ...
  return f16mat2x3(v_5, tint_bitcast_to_16bit(mix(v_6.xy, v_6.zw, bvec2(((((8u + start_byte_offset) & 15u) >> 2u) == 2u)))).xyz);
}
...
void main() {
  ...
  f16vec3 l_a_i_i = tint_bitcast_to_16bit(mix(v_12.xy, v_12.zw, bvec2(((((v_10 + v_11) & 15u) >> 2u) == 2u)))).xyz;
