...
f16mat2x4 v_3(uint start_byte_offset) {
  ...
  return f16mat2x4(v_5, tint_bitcast_to_16bit(mix(v_6.xy, v_6.zw, bvec2(((((8u + start_byte_offset) & 15u) >> 2u) == 2u)))));
}
...
void main() {
  ...
  f16mat2x4 l_a_i = v_3(v_10);
  uvec4 v_12 = v.inner[((v_10 + v_11) / 16u)];
  f16vec4 l_a_i_i = tint_bitcast_to_16bit(mix(v_12.xy, v_12.zw, bvec2(((((v_10 + v_11) & 15u) >> 2u) == 2u))));
  uvec4 v_13 = v.inner[((v_10 + v_11) / 16u)];
  v_1.inner = (((tint_bitcast_to_16bit_1(v_13[(((v_10 + v_11) & 15u) >> 2u)])[mix(1u, 0u, (((v_10 + v_11) % 4u) == 0u))] + l_a[0u][0u].x) + l_a_i[0u].x) + l_a_i_i.x);
}
