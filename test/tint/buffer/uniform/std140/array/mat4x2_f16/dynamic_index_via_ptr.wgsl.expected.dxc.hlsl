...
void f() {
  ...
  uint v_12 = a[((v_10 + v_11) / 16u)][(((v_10 + v_11) & 15u) >> 2u)];
  uint v_13 = (((((v_10 + v_11) % 4u) == 0u)) ? (0u) : (1u));
  s.Store<float16_t>(0u, (((tint_bitcast_to_f16(v_12)[v_13] + l_a[0u][0u].x) + l_a_i[0u].x) + l_a_i_i.x));
}
