...
f16mat4x2 v_3(uint start_byte_offset) {
  ...
  f16vec2 v_5 = tint_bitcast_to_16bit(v.inner[((4u + start_byte_offset) / 16u)][(((4u + start_byte_offset) & 15u) >> 2u)]);
  f16vec2 v_6 = tint_bitcast_to_16bit(v.inner[((8u + start_byte_offset) / 16u)][(((8u + start_byte_offset) & 15u) >> 2u)]);
  return f16mat4x2(v_4, v_5, v_6, tint_bitcast_to_16bit(v.inner[((12u + start_byte_offset) / 16u)][(((12u + start_byte_offset) & 15u) >> 2u)]));
}
...
void main() {
  ...
  f16vec2 l_a_i_i = tint_bitcast_to_16bit(v.inner[((v_10 + v_11) / 16u)][(((v_10 + v_11) & 15u) >> 2u)]);
  uvec4 v_12 = v.inner[((v_10 + v_11) / 16u)];
  v_1.inner = (((tint_bitcast_to_16bit(v_12[(((v_10 + v_11) & 15u) >> 2u)])[mix(1u, 0u, (((v_10 + v_11) % 4u) == 0u))] + l_a[0u][0u].x) + l_a_i[0u].x) + l_a_i_i.x);
}
