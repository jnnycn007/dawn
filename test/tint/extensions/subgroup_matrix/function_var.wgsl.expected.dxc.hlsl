...
void main() {
  ...
  Matrix<ComponentType::F32, 8, 8, MatrixUse::A, MatrixScope::Wave> v_2 = m;
  uint v_3 = 0u;
  buffer.GetDimensions(v_3);
  if ((((0u + (64u * 7u)) + 8u) <= (v_3 / 4u))) {
    v_2.Store(buffer, 0u, 256u, MatrixLayout::RowMajor);
  }
  Matrix<ComponentType::F32, 8, 8, MatrixUse::A, MatrixScope::Wave> v_4 = m_array[0u];
  uint v_5 = 0u;
  buffer.GetDimensions(v_5);
  if ((((0u + (64u * 7u)) + 8u) <= (v_5 / 4u))) {
    v_4.Store(buffer, 0u, 256u, MatrixLayout::RowMajor);
  }
  Matrix<ComponentType::F32, 8, 8, MatrixUse::A, MatrixScope::Wave> v_6 = m_nested_array[1u][2u];
  uint v_7 = 0u;
  buffer.GetDimensions(v_7);
  if ((((0u + (64u * 7u)) + 8u) <= (v_7 / 4u))) {
    v_6.Store(buffer, 0u, 256u, MatrixLayout::RowMajor);
  }
  Matrix<ComponentType::F32, 8, 8, MatrixUse::A, MatrixScope::Wave> v_8 = m_struct.l;
  uint v_9 = 0u;
  buffer.GetDimensions(v_9);
  if ((((0u + (64u * 7u)) + 8u) <= (v_9 / 4u))) {
    v_8.Store(buffer, 0u, 256u, MatrixLayout::RowMajor);
  }
  Matrix<ComponentType::F32, 8, 8, MatrixUse::B, MatrixScope::Wave> v_10 = m_nested_struct.s.r;
  uint v_11 = 0u;
